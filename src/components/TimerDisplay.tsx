...
import { CLR_YELLOW, neo } from '../constants';
...
const TimerDisplay: React.FC<Props> = ({ time }) => (
  <div
    className={`absolute top-5 left-1/2 -translate-x-1/2 z-20 flex items-center gap-2 text-black px-4 py-2 rounded-xl ${neo} font-mono font-black`}
